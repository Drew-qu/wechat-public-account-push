export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxa18ca1465ee82af4",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "ca25aed6b77469b3ed3d51ee6eb886c7",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "生日", "name": "老婆", "year": "1996", "date": "09-25"},
        // {"type": "节日", "name": "恋爱纪念日", "year": "2021", "date": "02-06"},
    ...
    },
    {
      ...
      name: "阿度同学",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oI2Ej6ZBLgBmIq3zw1hF40IAlbDg",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "6a5aCZiPL6aBXCDdiB-lyhfhuxDlAjH0rCMkpg4BH-0",
      // 所在省份
      province: "浙江",
      // 所在城市
      city: "杭州",
      ...
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "生日", "name": "自己", "year": "1997", "date": "01-21"},
        // {"type": "节日", "name": "恋爱纪念日", "year": "2021", "date": "02-06"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        // {"type": "生日", "name": "李四", "year": "1996", "date": "09-31"},
        // {"type": "节日", "name": "被搭讪纪念日", "year": "2021", "date": "09-01"},
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "生日", "name": "小夏", "year": "1996", "date": "09-25", isShowAge: true},
    {"type": "节日", "name": "恋爱纪念日", "year": "2021", "date": "02-06"},,
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
